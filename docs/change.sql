...
alter table ims_contract add column delivery_address text comment 'if this address is null, use client address for contract printing';
alter table ims_contract add column shipping_cost bigint comment 'usd';
alter table ims_contract add column transaction_fee bigint;
alter table ims_contract add column terms_of_sale text;
alter table ims_contract add column insurance_cost text;
alter table ims_contract add column additional_cost text;
